...
if __name__ == "__main__":
    ...
    # 2. Menghubungkan kelas logika pengontrol aksi ke dalam objek jendela utama
    mainWindow.logic = KasirGuiLogic(mainWindow)
    
    # 3. Mengeluarkan susunan canvases dan melahirkan seluruh objek widget komponen di layar
